...
int Stage_Flag=0;
      int Threshold=250;
  bool LeftOnLine=false, RightOnLine=false, MiddleOnLine=false;
...
void loop()
{
  ...
  switch(ui_Robot_State_Index)
  {
    case 0:    //Robot stopped
    {
     ...
     // delay(1000);
      ...
      int sensorValue=analogRead( ci_Light_Sensor);
  ...
  RightOnLine=false;
  MiddleOnLine=false;
  if(ui_Left_Line_Tracker_Data>Threshold) LeftOnLine=true;
  if(ui_Right_Line_Tracker_Data>Threshold) RightOnLine=true;
  if(ui_Middle_Line_Tracker_Data>Threshold) MiddleOnLine=true;
       if(Stage_Flag==0){
        MoveBackward();
       }
       if(Stage_Flag==1){
...
//       if(ui_Middle_Line_Tracker_Data>Threshold) MiddleOnLine=true;
       if(!LeftOnLine){
         ...
         if(Stage_Flag==6){
          MoveFoward();
//          if(RightOnLine&&MiddleOnLine&&LeftOnLine){
//          Stage_Flag++;}
         }
         if(Stage_Flag==7){
          MoveBackward();
...
//       if(ui_Middle_Line_Tracker_Data>Threshold) MiddleOnLine=true;
       ...
       {
        ui_Right_Motor_Speed=0;
        ui_Left_Motor_Speed=1800;                    //We can change this value
       }
       else if(MiddleOnLine&&LeftOnLine&&RightOnLine)
       {
        ui_Left_Motor_Speed=0;
...
//       if(ui_Middle_Line_Tracker_Data>Threshold) MiddleOnLine=true;
       ...
       else if(LeftOnLine&&(!RightOnLine))       //Turn Right
       {
        ui_Right_Motor_Speed=0;
        ui_Left_Motor_Speed=1300;        
       }
       else if(RightOnLine&&(!LeftOnLine))      //Turn Left
       {
        ui_Right_Motor_Speed=1300;
        ui_Left_Motor_Speed=0;                    //We can change this value
       }
       else if(MiddleOnLine&&LeftOnLine&&RightOnLine)
       {
        ui_Left_Motor_Speed=1300;
